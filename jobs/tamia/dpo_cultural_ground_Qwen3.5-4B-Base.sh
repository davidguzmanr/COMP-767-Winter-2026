#!/usr/bin/env bash
#SBATCH --job-name=dpo_cultural_ground_Qwen3.5-4B-Base
#SBATCH --nodes=1
...
accelerate launch --num_processes 4 --mixed_precision bf16 scripts/dpo_cultural_ground.py \
    --model_name_or_path checkpoints/SFT-Qwen3.5-4B-Base-CulturalGround/checkpoint-20000 \
    --chat_template_source Qwen/Qwen3.5-4B \
    --output_dir checkpoints/DPO-Qwen3.5-4B-Base-CulturalGround \
    --num_train_epochs 1 \
