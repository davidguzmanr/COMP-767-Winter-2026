#!/bin/bash
#SBATCH --job-name=gpt_judge
#SBATCH --output=job_output_gpt_judge.txt
#SBATCH --error=job_error_gpt_judge.txt
#SBATCH --gres=gpu:1
#SBATCH --time=1:00:00
#SBATCH --mem=32G
...
python /home/mila/m/maltaism/culture_drifts/sft_dpo/COMP-767-Winter-2026/batch_gpt_judge.py