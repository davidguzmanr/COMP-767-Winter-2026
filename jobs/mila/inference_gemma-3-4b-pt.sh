...
python scripts/inference_at_checkpoint.py \
    --model_id google/gemma-3-4b-pt \
    --chat_template_source google/gemma-3-4b-it \
    --checkpoint checkpoints/SFT-gemma-3-4b-pt-CulturalGround/checkpoint-5000 \
    --output results/gemma-3-4b-pt-sft-5000.jsonl \
    --batch_size 32 \
    --use_system_prompt
...
python scripts/inference_at_checkpoint.py \
    --model_id google/gemma-3-4b-pt \
    --chat_template_source google/gemma-3-4b-it \
    --checkpoint checkpoints/SFT-gemma-3-4b-pt-CulturalGround/checkpoint-10000 \
    --output results/gemma-3-4b-pt-sft-10000.jsonl \
    --batch_size 32 \
    --use_system_prompt
...
python scripts/inference_at_checkpoint.py \
    --model_id google/gemma-3-4b-pt \
    --chat_template_source google/gemma-3-4b-it \
    --checkpoint checkpoints/SFT-gemma-3-4b-pt-CulturalGround/checkpoint-15000 \
    --output results/gemma-3-4b-pt-sft-15000.jsonl \
    --batch_size 32 \
    --use_system_prompt
